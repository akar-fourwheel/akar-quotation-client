...
const StockUpdateDashboard = () => {
  const [loadingStates, setLoadingStates] = useState({});
  const [results, setResults] = useState({});

  const updateEndpoints = [
    { key: 'dealer', label: 'Dealer Stock', endpoint: 'update/update-dealer' },
    { key: 'plant', label: 'Plant Stock', endpoint: 'update/update-plant' },
    { key: 'zonal', label: 'Zonal Stock', endpoint: 'update/update-zonal' },
    { key: 'zawl', label: 'ZAWL Stock', endpoint: 'update/update-zawl' },
  ];
    ...
    <div className="max-w-6xl mx-auto">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-gray-600 mb-6">
          Update various stock data components
        </p>
        ...
        <div className="border-t pt-6">
          <div className="text-center">
            ...
            >
              ...
              {loadingStates.all ? 'Updating All...' : 'Update All Stock Data'}
            </button>
                  ...
                  {Object.entries(results)
                    ...
                    .map(([key, result]) => (
                      <div key={key} className="flex items-center text-sm text-green-600 bg-green-50 p-2 rounded">
                        ...
                        {key === 'all' ? 'All Stock Data' : updateEndpoints.find(e => e.key === key)?.label || key}
                      </div>
                    ))}
...
export default StockUpdateDashboard;